...
window.FOODS = [
  ...
  // Desserts & bakery
  { n: "Brownie", u: "piece", c: 250, p: 3.5, a: ["brownie", "chocolate brownie", "walnut brownie"] },
  { n: "Muffin", u: "piece", c: 220, p: 4, a: ["muffin", "chocolate muffin", "blueberry muffin"] },
  { n: "Donut", u: "piece", c: 250, p: 4, a: ["donut", "doughnut"] },
  { n: "Cookie", u: "cookie", c: 140, p: 1.6, a: ["cookie", "chocolate chip cookie"] },
  { n: "Brownie with ice cream", u: "plate", c: 450, p: 6, a: ["brownie with ice cream", "sizzling brownie", "brownie sundae"] },
  { n: "Waffle", u: "piece", c: 310, p: 6, a: ["waffle", "belgian waffle"] },
  { n: "Pancakes (2)", u: "2 pcs", c: 350, p: 8, a: ["pancake", "pancakes"] },
  { n: "Cheesecake slice", u: "slice", c: 320, p: 6, a: ["cheesecake"] },
  { n: "Rasmalai", u: "piece", c: 140, p: 4, a: ["rasmalai", "ras malai"] },
  { n: "Kheer / payasam", u: "bowl", c: 230, p: 6, a: ["kheer", "payasam", "rice kheer"] },
  { n: "Halwa", u: "bowl", c: 300, p: 4, a: ["halwa", "gajar halwa", "sooji halwa", "halua"] },
  { n: "Laddu", u: "piece", c: 180, p: 3, a: ["laddu", "ladoo", "besan laddu", "motichoor"] },
  { n: "Barfi", u: "piece", c: 160, p: 3, a: ["barfi", "burfi", "kaju katli"] },
  { n: "Soan papdi", u: "piece", c: 110, p: 1.5, a: ["soan papdi"] },
  { n: "Brownie cake / chocolate cake", u: "slice", c: 350, p: 4.5, a: ["chocolate cake", "brownie cake", "choco lava cake", "lava cake"] },

  // South Indian
  { n: "Rava dosa", u: "dosa", c: 230, p: 4, a: ["rava dosa"] },
  { n: "Set dosa (2)", u: "2 pcs", c: 250, p: 6, a: ["set dosa"] },
  { n: "Onion dosa", u: "dosa", c: 240, p: 5, a: ["onion dosa", "onion uttapam"] },
  { n: "Ghee roast dosa", u: "dosa", c: 330, p: 5, a: ["ghee roast", "ghee roast dosa"] },
  { n: "Pongal (ven pongal)", u: "bowl", c: 300, p: 8, a: ["pongal", "ven pongal", "khara pongal"] },
  { n: "Lemon rice", u: "bowl", c: 280, p: 5, a: ["lemon rice", "chitranna"] },
  { n: "Tomato rice", u: "bowl", c: 290, p: 5, a: ["tomato rice"] },
  { n: "Coconut rice", u: "bowl", c: 320, p: 5, a: ["coconut rice"] },
  { n: "Bisi bele bath", u: "bowl", c: 330, p: 9, a: ["bisi bele bath", "bisibelebath", "bisi bele"] },
  { n: "Appam (2)", u: "2 pcs", c: 220, p: 4, a: ["appam", "aapam"] },
  { n: "Idiyappam (3)", u: "3 pcs", c: 220, p: 4, a: ["idiyappam", "string hopper"] },
  { n: "Puttu", u: "bowl", c: 250, p: 5, a: ["puttu"] },
  { n: "Coconut chutney (2 tbsp)", u: "2 tbsp", c: 70, p: 1.5, a: ["coconut chutney", "chutney", "nariyal chutney"] },
  { n: "Filter coffee", u: "cup", c: 90, p: 3, a: ["filter coffee", "south indian coffee", "kaapi"] },

  // Chinese & continental
  { n: "Veg fried rice", u: "plate", c: 350, p: 8, a: ["fried rice", "veg fried rice"] },
  { n: "Chicken fried rice", u: "plate", c: 420, p: 20, a: ["chicken fried rice", "egg fried rice"] },
  { n: "Hakka noodles (veg)", u: "plate", c: 340, p: 8, a: ["hakka noodles", "noodles", "chowmein", "chow mein"] },
  { n: "Chicken noodles", u: "plate", c: 420, p: 20, a: ["chicken noodles", "chicken chowmein"] },
  { n: "Veg manchurian", u: "plate", c: 300, p: 7, a: ["manchurian", "veg manchurian", "gobi manchurian"] },
  { n: "Chilli paneer", u: "plate", c: 350, p: 16, a: ["chilli paneer", "chili paneer"] },
  { n: "Chilli chicken", u: "plate", c: 380, p: 26, a: ["chilli chicken", "chili chicken"] },
  { n: "Spring roll (2)", u: "2 pcs", c: 200, p: 5, a: ["spring roll", "spring rolls"] },
  { n: "Pasta (white sauce)", u: "plate", c: 400, p: 12, a: ["white sauce pasta", "alfredo pasta", "creamy pasta"] },
  { n: "Pasta (red sauce)", u: "plate", c: 350, p: 11, a: ["pasta", "red sauce pasta", "arrabiata", "penne"] },
  { n: "Garlic bread (2)", u: "2 pcs", c: 220, p: 6, a: ["garlic bread"] },
  { n: "Grilled sandwich", u: "sandwich", c: 300, p: 9, a: ["grilled sandwich", "cheese sandwich", "veg sandwich"] },
  { n: "Hot dog", u: "piece", c: 290, p: 11, a: ["hot dog", "hotdog"] },
  { n: "Wrap / roll (veg)", u: "wrap", c: 320, p: 9, a: ["wrap", "veg wrap", "veg roll"] },
  { n: "Chicken wrap / roll", u: "wrap", c: 400, p: 22, a: ["chicken wrap", "chicken roll", "kathi roll"] },

  // Everyday combos & extras
  { n: "Dal khichdi", u: "bowl", c: 300, p: 10, a: ["khichdi", "dal khichdi", "khichri"] },
  { n: "Rajma chawal", u: "plate", c: 450, p: 15, a: ["rajma chawal", "rajma rice"] },
  { n: "Chole chawal", u: "plate", c: 460, p: 15, a: ["chole chawal", "chole rice", "chana rice"] },
  { n: "Veg pulao", u: "bowl", c: 280, p: 6, a: ["pulao", "veg pulao", "pulav"] },
  { n: "Pizza slice", u: "slice", c: 270, p: 10, a: ["pizza", "pizza slice"] },
  { n: "Burger (veg)", u: "burger", c: 350, p: 10, a: ["burger", "veg burger", "aloo tikki burger"] },
  { n: "Chicken burger", u: "burger", c: 450, p: 25, a: ["chicken burger"] },
...
(function () {
  ...
  function emojiFor(name) {
    ...
    const rules = [
      ...
      [/rice|pulao|biryani|khichdi|pongal|bisi bele/, "🍚"],
      [/dal|sambar|rajma|chole|chana masala|kadhi|curry|makhani|sabzi|bhurji|soup|rasam|manchurian/, "🍲"],
      [/idli|dhokla/, "🍘"], [/dosa|uttapam|chilla|appam|idiyappam|puttu/, "🥞"],
      ...
      [/maggi|noodle|chowmein|chow mein/, "🍜"], [/pasta|penne|alfredo|arrabiata/, "🍝"],
      [/hot ?dog/, "🌭"], [/wrap|frankie|kathi|roll\b/, "🌯"], [/shake|smoothie/, "🥤"],
      [/cookie|biscuit|parle/, "🍪"], [/muffin|donut|doughnut|waffle|pancake|cupcake/, "🧁"],
      [/brownie|cheesecake|lava cake/, "🍫"],
      [/rasmalai|kheer|payasam|halwa|laddu|ladoo|barfi|burfi|soan papdi|kaju katli|rasgulla/, "🍮"],
